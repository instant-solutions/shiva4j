...
public class Shiva4J {
   ...
   * @param album
   *          The album.
   * @return A collection of album's artists. <code>null</code> if JSON content
   ...
   * @param id
   *          The album's ID.
   * @return The album. <code>null</code> if JSON content is not well formatted.
   * @throws IOException
   *           if network errors occurs.
   */
   ...
   * @param id
   *          The track's ID.
   * @return The track. <code>null</code> if JSON content is not well formatted.
   * @throws IOException
   *           if network errors occurs.
   */
   ...
   * @param trackId
   *          The lyric's ID.
   * @return The lyric. <code>null</code> if JSON content is not well formatted.
   * @throws IOException
   *           if network errors occurs.
   */
